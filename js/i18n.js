/* Arabic translations. English is read from the HTML itself at startup. */
window.RAFAQ_I18N = {
  ar: {
    ...
    "hero.badge": "نستقبل مشاريع 2026 الآن",
    "hero.l1": "نصمّم ونبني",
    ...
    "proc.1.t": "الاكتشاف",
    "proc.1.d": "ورش عمل وأبحاث مستخدمين وتحديد أهداف. نفهم عملك قبل أن نرسم أي بكسل.",
    "proc.2.t": "التصميم",
    "proc.2.d": "رحلات المستخدم والمخططات والواجهات النهائية، ونختبرها مع مستخدمين حقيقيين.",
    "proc.3.t": "التطوير",
    "proc.3.d": "كود نظيف ومختبر عبر دورات أسبوعية. ترى التقدم كل أسبوع.",
    "proc.4.t": "الإطلاق",
    "proc.4.d": "اختبار الجودة وتحسين الأداء والنشر على المتاجر وإطلاق سلس.",
    "proc.5.t": "النمو",
    ...
    "ct.sub": "أخبرنا عن فكرتك، وسنرد عليك خلال 24 ساعة بالخطوات التالية.",
    "ct.name": "اسمك",
    "ct.email": "البريد الإلكتروني",
    "ct.need": "أحتاج إلى",
    "ct.msg": "حدّثنا عن مشروعك",
    "ct.send": "أرسل الرسالة",
    "ct.ok": "شكرًا لك! وصلتنا رسالتك وسنتواصل معك قريبًا.",
    "ct.err": "يرجى تعبئة الاسم والبريد الإلكتروني والرسالة بشكل صحيح.",
